...
namespace Helsenorge.Messaging.ServiceBus
{
    ...
    internal class ServiceBusMessage : IMessagingMessage
    {
        ...
        {
            [DebuggerStepThrough]
            get { return GetValue(ServiceBusCore.FromHerIdHeaderKey, 0); }
            [DebuggerStepThrough]
        ...
        {
            [DebuggerStepThrough]
            get { return GetValue(ServiceBusCore.ToHerIdHeaderKey, 0); }
            [DebuggerStepThrough]
        ...
        {
            [DebuggerStepThrough]
            get { return GetValue(ServiceBusCore.ApplicationTimestampHeaderKey, DateTime.MinValue); }
            [DebuggerStepThrough]
        ...
        {
            [DebuggerStepThrough]
            get { return GetValue(ServiceBusCore.CpaIdHeaderKey, string.Empty); }
            [DebuggerStepThrough]
        ...
        {
            [DebuggerStepThrough]
            get { return _implementation.ContentType; }
            [DebuggerStepThrough]
            set { _implementation.ContentType = value; }
        }
        public string CorrelationId
        {
            [DebuggerStepThrough]
            get { return _implementation.CorrelationId; }
            [DebuggerStepThrough]
            set { _implementation.CorrelationId = value; }
        }
        public string MessageFunction
        {
            [DebuggerStepThrough]
            get { return _implementation.Label; }
            [DebuggerStepThrough]
            set { _implementation.Label = value; }
        }
        public string MessageId
        {
            [DebuggerStepThrough]
            get { return _implementation.MessageId; }
            [DebuggerStepThrough]
            set { _implementation.MessageId = value; }
        }
        public string ReplyTo
        {
            [DebuggerStepThrough]
            get { return _implementation.ReplyTo; }
            [DebuggerStepThrough]
            set { _implementation.ReplyTo = value; }
        }
        public DateTime ScheduledEnqueueTimeUtc
        {
            [DebuggerStepThrough]
            get { return _implementation.ScheduledEnqueueTimeUtc; }
            [DebuggerStepThrough]
            set { _implementation.ScheduledEnqueueTimeUtc = value; }
        }
        public TimeSpan TimeToLive
        {
            [DebuggerStepThrough]
            get { return _implementation.TimeToLive; }
            [DebuggerStepThrough]
            set { if (value > TimeSpan.Zero) _implementation.TimeToLive = value; }
        }
        public string To
        {
            [DebuggerStepThrough]
            get { return _implementation.To; }
            [DebuggerStepThrough]
            set { _implementation.To = value; }
        }
        [DebuggerStepThrough]
